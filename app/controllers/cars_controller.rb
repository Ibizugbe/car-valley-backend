class CarsController < ApplicationController
  ...
  # POST /cars
  def create
    existing_car = Car.find_by(topic: car_params[:topic], user_id: car_params[:user_id], technology_id: car_params[:technology_id])
    existing_join = Profession.find_by(user_id: car_params[:user_id], technology_id: car_params[:technology_id])

    if !existing_join
      Profession.create(user_id: car_params[:user_id], technology_id: car_params[:technology_id])
    end
